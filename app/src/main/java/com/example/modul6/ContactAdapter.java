        ...
        RecyclerView.Adapter<ContactAdapter.ContactViewHolder>
{
    ...
    private List<com.example.modul6.ContactModel> contactList;
    private static ClickListener clickListener;
    public ContactAdapter(Context context,
                          ArrayList<com.example.modul6.ContactModel> contactList){
    ...
    public void onBindViewHolder(@NonNull
        ...
        final com.example.modul6.ContactModel contact = contactList.get(position);
